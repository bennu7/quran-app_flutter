// API juz URL : https://api.quran.sutanlab.id/juz/1
// GET detail juz dalam Al-Quran
...
class Verses {
  ...
  Verses.fromJson(Map<String, dynamic> json) {
    ...
    text = json['text'] != null ? new Teks.fromJson(json['text']) : null;
...
class Teks {
  ...
  Teks({this.arab, this.transliteration});
